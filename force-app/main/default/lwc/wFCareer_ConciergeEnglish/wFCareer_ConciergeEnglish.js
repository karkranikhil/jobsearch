...
import { OMNIDEF } from './wFCareer_ConciergeEnglish_def.js';
import tmpl from './wFCareer_ConciergeEnglish.html';
import tmpl_nds from './wFCareer_ConciergeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class wFCareer_ConciergeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
